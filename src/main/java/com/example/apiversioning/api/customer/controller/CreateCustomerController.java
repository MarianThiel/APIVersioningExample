...
public class CreateCustomerController {
    ...
    public Mono<Void> createCustomerV1(@RequestBody DtoV1 customer){
    ...
    public Mono<Void> createCustomerV2(@RequestBody DtoV2 customer){
        CustomerDto customerDto = versioningService.toCustomerDto(customer);
        Customer domainCustomer = CustomerMapper.toDomain(customerDto);
        return createCustomerUseCase.createCustomer(domainCustomer);
    }
    ...
    public Mono<Void> createCustomerV3(@RequestBody @Nonnull DtoV3 customer){
        CustomerDto customerDto = versioningService.toCustomerDto(customer);
        Customer domainCustomer = CustomerMapper.toDomain(customerDto);
        return createCustomerUseCase.createCustomer(domainCustomer);
    }
